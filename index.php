...
<body>
    <header></header>
    <main class="container border g-0">
    <div class="row align-items-start">
        <!-- Colonne gauche -->
        <div class="col-lg-4 col-6 g-0">
            <div>
                <img src="./assets/images/photoProfile.jpg" class="rounded-circle mx-auto d-block" width="50%" alt="photo de profil">
            </div>

            <!-- Contact -->
            <div id="contact" class="px-5 mt-3">
                <div class="fs-5 fw-bold mb-2">CONTACT</div>
                <div class="mb-2">
            ...
            <!-- Profil -->
            <div id="profil" class="px-5 mt-3">
            <div class="fs-5 fw-bold mb-2">PROFIL</div>
            <div>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div>
            </div>
        </div>

        <!-- Colonne droite -->
        <div class="col-lg-8 col-6 g-0 p_colonne_droite">
